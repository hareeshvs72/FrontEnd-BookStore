               ...
               <Link to={'/login'}  >
                ...
                <div className='relative inline-block text-left'>
                      ...
                      <button type='button' onClick={()=>setDropDownStatus(!dropDownStatus)} className='w-full bg-white px-2 py-2 shadow-xs hover:bg-gray-50 '>
                        <img src={userDp == "" ? "https://cdn-icons-png.flaticon.com/512/219/219988.png" : userDp.startsWith("https://lh3.googleusercontent.com/")?userDp : `${SERVERURL}/uploads/${userDp}`  } width={'40px'} height={'40px'}  style={{borderRadius:'50%'}} alt="user Dp" />
                      </button>
                      { dropDownStatus &&
                        ...
                        <div className="py-1 ">
                          ...
                          <button type='button' className='' onClick={logout} ><FontAwesomeIcon icon={faPowerOff} className='me-2' />Logout </button>
                        </div>
                      </div>}
               ...
               <Link to={'/login'}  >
                ...
                <div className='relative inline-block text-left'>
                      ...
                      { dropDownStatus &&
                        ...
                        <div className="py-1 ">
                          <Link className='block  py-2  text-sm text-gray-700' to={'/profile'}> <p><FontAwesomeIcon icon={faAddressCard} className='me-2' /> Profile </p></Link>
                          <Link  className='block  py-2  text-sm text-gray-700' onClick={logout} > <p><FontAwesomeIcon icon={faPowerOff} className='me-2' /> Logout </p></Link>
